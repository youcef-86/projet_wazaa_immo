...
CREATE TABLE waz_commune(
        ...
        commune_distance_agence      int NOT NULL,
        commune_nombre_habitant      int NOT NULL
        );
...
CREATE TABLE waz_agent(
        ...
        FOREIGN KEY (agent_loc_id)  REFERENCES waz_location(loc_id),
        FOREIGN KEY (agent_vente_id)  REFERENCES waz_vente(vente_id),
        FOREIGN KEY (agent_an_id)  REFERENCES waz_annonce(an_id)
	);
...
CREATE TABLE waz_location(
        ...
        loc_locataire             Varchar (50) NOT NULL,
...
CREATE TABLE waz_vente(
        ...
        vente_nouveauproprietaire   varchar (50) NOT NULL,
        vente_proprietaire          varchar (50) NOT NULL,
...
CREATE TABLE waz_prospects(
        ...
        prop_avisimpots             int NOT NULL,
        prop_3drs_bultins_salaire   varchar (255)  NOT NULL,
